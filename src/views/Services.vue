<template>
    <div class="services-container">
        <div class="service-card none" v-for="service in services" :key="service.id"
            :class="{ 'fade-in': fadeInActive[service.id - 1] }">
            <div class="service-header">{{ service.number }}</div>
    ...
    data() {
        return {
            services: [
                ...
                { id: 6, number: "06", title: "Développement Logiciel", description: "Je peux contribuer et vous aidez à la création/amélioration de vos logiciels !" },
...
.service-card {
    ...
    /* Couleur légèrement plus claire que le fond pour le contraste */
    color: #ffffff;
    padding: 20px;
    margin: 20px;
    width: calc(45% - 40px);
...
.service-card:hover {
    ...
    /* Effet de survol pour plus de dynamisme */
...
.service-header {
    ...
    font-weight: bold;
    color: #e91e63;
    /* Accent couleur pour le titre (rose vif) */
}

.service-content h3 {
    margin-top: 10px;
    color: #ff80ab;
    /* Couleur rose pâle pour les titres */
}

.service-content p {
    font-size: 16px;
    color: #e0e0e0;
    /* Texte descriptif en gris clair */
    line-height: 1.5;
}
...
@media (max-width: 768px) {
    ...
    .service-content p {
        font-size: 14px;
        /* Texte plus petit pour les écrans étroits */
    }
...
@media (max-width: 480px) {
    .service-header {
        font-size: 18px;
        /* Réduction supplémentaire du titre */
    }
    ...
    .service-content p {
        font-size: 12px;
        /* Texte descriptif encore plus compact */
    }
